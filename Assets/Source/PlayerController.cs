...
public class PlayerController : MonoBehaviour
{
    ...
    public IEnumerator BeginDoingOneGeneration()
    {
        ...
        {
            var eval = new Assets.Source.BattleEvaluator<NeatGenome>(this);
    ...
    private Assets.Source.BattleExperiment CreateExperiment(int warriors)
    {
        var experiment = new Assets.Source.BattleExperiment();

        var battleEvaluator = new Assets.Source.BattleEvaluator<NeatGenome>(this);
