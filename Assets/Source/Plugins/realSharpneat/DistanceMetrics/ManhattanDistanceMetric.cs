...
namespace SharpNeat.DistanceMetrics
{
    ...
    public class ManhattanDistanceMetric : IDistanceMetric
    {
        ...
        private readonly double _matchDistanceCoeff;
        ...
        private readonly double _mismatchDistanceCoeff;
        ...
        private readonly double _mismatchDistanceConstant;
        ...
        #endregion IDistanceMetric Members
    }
}